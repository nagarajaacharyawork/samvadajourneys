        ...
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <div className="flex items-center gap-3">
              <img src="/samvada journey's profile (blue + white).jpg.jpeg" alt="Samvada Journeys" className="h-12 w-12 rounded-full object-cover" />
              <div>
          ...
          {[
            { title: "Explore", links: [["Experiences", "/experiences"], ["Upcoming Trips", "/trips"], ["Blog & Stories", "/blog"]] },
            { title: "Company", links: [["About Us", "/about"], ["Partner With Us", "/about"], ["Contact", "/contact"]] },
            { title: "Support", links: [["FAQs", "/contact"], ["Booking Policy", "/contact"], ["Get in Touch", "/contact"]] },
          ].map((col) => (
            <div key={col.title}>
